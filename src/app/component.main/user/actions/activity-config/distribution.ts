...
@Component({
    selector : 'activity-distribution-config',
...
export class ActivityDistributionConfigComponent implements OnInit{
    ngOnInit(): void {
    }
    //预览的初始位置
    previewPos = 0;
    pageConfig = {
        mainImage : '//img1.huocaicf.com/act/activityCenter/201610141425.jpg',
        ...
        registerSuccess: {
            type: '1',
            bgColor: '#D1ECF7',
            bgImage: '//img1.huocaicf.com/act/activityCenter/201610141142.jpg',
            target: {
                type: '1',
                url: '',
                params: '',
